...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("Aperture Test Project"); // Tile of report
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		screenshotname=CaptureSceenShots.generateFileName(tr);
		try {
	...
	public void onFinish(ITestContext testContext)
	{
		...
		extent.flush();
		System.out.println("Report Test is "+reportpath);
