...
public class AddResource {
	...
	//@FindBy(xpath="//input[@type='file']/following-sibling::span[contains(text(),'Select Profile Picture')]")
	...
	public void clickOnAddResource()
	{
		...
		llogger.info("on add account  refrence "+btnAddResource.getText());
	...
	public void enterName(String name)
	{
		...
		llogger.info("entring name  "+name);
		txtName.clear();
	...
	public void checkRadioGender(String valueOfGender)
	{
		...
		llogger.info("checking gender radio button "+valueOfGender);
		
         int RowCount = radioGender.size();
         for (int i = 0; i < RowCount; i++)
         {
         // Check the check boxes based on index
        	 System.out.println(radioGender.get(i).getText());
	...
	public void enterCompanyName(String companyname)
	{
		...
		llogger.info("entring Company Name "+companyname);
	...
	public void enterDepartment(String department)
	{
		...
		llogger.info("entring Department Name "+department);
		txtDepartment.click();
		txtDepartment.clear();
	...
	public void enterDesignation(String designation)
	{
		...
		llogger.info("entring designation of resource "+designation);
	...
	public void enterBaseLocation(String baseLocation)
	{
		...
		llogger.info("entring baseLocation "+baseLocation);
	...
	public void enterJoiningDate(String joiningdate)
	{
		...
		llogger.info("entering joining date "+joiningdate);
	...
	public void selectPractices()
	{
		...
		llogger.info("selecting Practices ");
	...
	public void enterPractices(String[] practicename)
	{
		...
		llogger.info("entered practice in searchbox ");
	...
	public  void selectPractice(String practicename)
	{
		for(int i=0;i<=listpractices.size()+1;i++) {
			...
			if(listpractices.get(i).getText().trim().equals(practicename)) {
				...
				llogger.info(listpractices.get(i).getText().trim());
	...
	public void enterPSkills(String[] pskills)
	{
		...
		llogger.info("entring primary skills ");
	...
	public void enterSSkills(String[] sskills)
	{
		...
		llogger.info("entring secondary skills ");
	...
	{
		llogger.info("image path is "+path);
	...
	public void cropProfilePicture()
	{
		...
		js.executeScript("arguments[0].setAttribute('style', 'top: 2px; left: 122px; width: 193px; height: 193px; margin-left: calc(50% - 228px); visibility: visible;')",divCropper);
		btnsaveimage.click();
	...
	public void clickOnCreateResource()
	{
		...
		llogger.info("creating resource ");
	...
	{
		llogger.info("checking employee type radio button ");
        ...
        // Check the check boxes based on index
       	 ...
       	 System.out.println("value of employee type" +radioEmployeeType.get(i).getText().contentEquals(valueOfEmployee));
